...
<body>
    ...
    <div id="head">
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/img/dlibrary1.png"  />
        ...
        <table class="style1">
            <tr>
                <td>
                    &nbsp;</td>
                <td>
        <asp:Image ID="Image2" runat="server" ImageUrl="~/img/book1.png" Height="314px" 
                        style="margin-left: 65px" Width="580px" />
                </td>
            </tr>
        </table>
        </div>
